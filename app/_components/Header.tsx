  ...
  return (
    ...
    >
      ...
      <div className="h-screen flex z-100 bg-[#0000008d] items-center justify-center p-5 flex-col relative">
        <div className="flex gap-5 text-xl max-md:text-[15px] items-center justify-around w-full">
          <h2 className="font-bold underline text-green-200">
        ...
        <Canvas
          ...
          {/* OrbitControls отключён (или настроен) */}
          {/* <OrbitControls enableZoom={false} enablePan={false} enableRotate={true} /> */}
        </Canvas>
        <Image
          src="/partBgHeader.jpg"
          width={100}
          height={100}
          alt="part bg header"
        />{" "}
